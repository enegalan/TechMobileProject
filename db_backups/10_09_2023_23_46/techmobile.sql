...
--
-- Table structure for table `opinion_answer_replies`
--

DROP TABLE IF EXISTS `opinion_answer_replies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8 */;
CREATE TABLE `opinion_answer_replies` (
  `id` int NOT NULL AUTO_INCREMENT,
  `opinion_answer_id` int NOT NULL,
  `user_id` int NOT NULL,
  `date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `reply` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `opinion_answer_id` (`opinion_answer_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `opinion_answer_replies_ibfk_1` FOREIGN KEY (`opinion_answer_id`) REFERENCES `opinion_answers` (`id`),
  CONSTRAINT `opinion_answer_replies_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `opinion_answer_replies`
--

LOCK TABLES `opinion_answer_replies` WRITE;
/*!40000 ALTER TABLE `opinion_answer_replies` DISABLE KEYS */;
INSERT INTO `opinion_answer_replies` VALUES (1,1,4,'2023-09-10 21:43:00','This is a text to test the opinion answer replying.');
/*!40000 ALTER TABLE `opinion_answer_replies` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `opinion_answers` VALUES (1,1,1,'Muy bien','2023-08-27 20:41:46'),(2,1,1,'Muy bien','2023-08-27 20:41:49'),(3,1,3,'Hola muy buenas que placa base recomiendas para este procesador lo necestio para producción musical gracias un saludo','2023-09-10 21:40:57');
...
INSERT INTO `opinions` VALUES (1,1,1,1,'Esta bien',NULL,NULL,NULL,NULL,'2023-08-27 20:35:58',NULL),(2,1,1,1,'Es un pepino de procesador, de serie te lo da todo rendimiento increíble en multinúcleo en esta generación, pero su fuerte son los núcleos P-Cores. En juegos que decir, va de lujo. Es un procesador muy completo tanto para jugar como para aplicaciones de gran consumo de recursos.',NULL,'Frecuencias muy altas. Gran rendimiento. Gran margen de overclock. Combina muy bien con memorias de altas tasas de transferencia XMP-3. En mi caso unas de 7400 MT/s las he podido overclockear a 7800 MT/s sin problemas.','TJunction Altísimo 100ºC. En cuanto le das caña se calienta como tu prima la guarra. Precio algo elevado.',1,'2023-09-10 21:35:51',1);
...
INSERT INTO `useful_opinions` VALUES (1,1,'2023-08-27 20:37:02'),(1,2,'2023-08-27 20:37:06'),(1,3,'2023-09-10 21:38:48');
...
-- Dump completed on 2023-09-10 23:46:24
